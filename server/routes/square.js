...
router.post('/process-payment', function (req, res, next) {
	...
	function buildReceipt(order_data) {
		...
		if (!error && response.statusCode === 200) {
			...
			var discount_name=list[1].discounts.name;
